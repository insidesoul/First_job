        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p4298/audi_12.png" alt="Автоломбард под залог ПТС"/>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="car-top-transports">
                            <div class="car-top-transports1">
                                <img src="images/bmwg.png" alt="bmm">
                            </div>
                            ...
                            <div class="visible-on-mobile request-history">
                                <div class="m-b-30">
                                    <img style="max-width: 200px; width: 100%;" src="images/bmwg.png" alt="img" />
                                </div>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                   Да, возможно досрочное погашение кредита. Все, кто получили в нашем автоломбарде деньги под залог грузового автомобиля могут вернуть их как только появилась такая возможность. Штрафы и пени за преждевременное закрытие займа отсутствуют.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    При оформлении кредита собственник не меняется. Для получения займа клиент оставляет в автоломбарде в залог ПТС грузовика, сама машина не передается в пользование кредитору. ТС выступает обеспечением в рамках договора, который оформляется с нашей компанией.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Да, при оформлении займа в нашем автоломбарде в Хабаровске имеет значение год выпуска ТС. Если в залог идет ПТС грузовика отечественного производства, то машина должна быть не старше 10 лет, если иностранного — не старше 20 лет.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Взял кредит под залог ПТС грузового автомобиля и полностью доволен. Уже был готов заложить сам транспорт, а в ломбарде попросили только ПТС под залог. Не пришлось изменять план работы. Рекомендую!
                                </div>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Получил залог под ПТС грузового автомобиля, уже даже вернул долг. Деньги нужны были срочно, и вы просто выручили меня, за что огромное спасибо. Отдельно отмечу, что автомобиль остался у меня.
                                </div>
                                <div class="review-person">
                                    <div class="review-name">Максим П.</div>
                                </div>
                            </article>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Спасибо этому  автоломбарду, за то что выручил в трудную минуту. Искал место, где можно получить деньги под залог грузовых авто в Хабаровске, и не ошибся с выбором. Даже не пришлось отдавать автомобиль, за что благодарю отдельно.
                                </div>
                                <div class="review-person">
