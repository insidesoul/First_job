...
<head>
    ...
    <title>Займы под залог ПТС в Санкт-Петербурге</title>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-7">
                    <div class="header-form-block">
                        <h1 class="h1"><span class="h1-span">Займы под залог ПТС <br>в Санкт-Петербурге</span></h1>
        ...
        <div class="row">
            <div class="col-md-5 col-sm-12">
                <div class="bg-grey-man">
                    ...
                    <img src="images/p4298/cars.png" alt="Автоломбард под залог ПТС"/>
                </div>
            </div>
...
<script type="text/babel">
    let data = [
        [{question: 'Можно ли погасить займ, находясь в другом городе?'},
            {answer: 'Если вы хотите взять займ под залог ПТС онлайн и находитесь в другом городе, то для вас будут действовать точно такие же условия кредитования, как и для тех, кто оформляет кредитную линию в Санкт-Петербурге.'},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: 'Могу ли я получить одобрение займа, не приезжая в офис?'},
            {answer: 'При оформлении займа под залог ПТС без выходных в Санкт-Петербурге, вы можете воспользоваться расширенным функционалом обработки заявки в режиме онлайн, используя при этом сеть Интернет. '},
            {numId: '1'},
            {numIdText: 'One'}],
        ...
        [{question: 'Я купил автомобиль, но пока не оформил его в ГИБДД. Ваш ломбард выдает займы без регистрации транспортного средства?'},
            {answer: 'Если вы купили машину, но еще не успели оформить документы в ГИБДД, то получить займ под ПТС на карту можно по ДКП, а также, если имеется оформленная генеральная доверенность на управление транспортным средством.'},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
    ReactDOM.render(
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Данная контора хороша тем, что здесь можно получить займ под залог ПТС в Питере круглосуточно. При этом, условия всегда выгодными. Сам уже обращался сюда дважды, сделки проходили без проблем. Для составления договора не требуется много документов.
                        </div>
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Если срочно нужны деньги, то можно получить займ онлайн под залог ПТС на карту в этом автоломбарде. Сотрудники являются профессионалами, способны быстро подготовить необходимые документы для заключения сделки. Что удобно, оставить заявку можно прямо на сайте.
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Чтобы получить деньги оформил автозайм под ПТС в этом ломбарде Петербурга. Составление договора много времени не заняло, от меня вообще практически не потребовалось какой-либо информации, только документы. Деньги были отправлены мне на счет довольно быстро.
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Радует, что в Питере есть фирма, где можно взять займ под залог ПТС. Это существенно помогает мне при решении финансовых проблем. Сама регулярно обращаюсь в эту компанию, сотрудничество с ними - настоящее удовольствие, еще ни разу не было проблем.

                        </div>
                        <div class="review-person">
                            <div class="review-name">Василиса</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Из-за определенных обстоятельств срочно потребовались деньги. В этой ситуации мне помог быстрый займ под залог ПТС в данной организации. Сотрудники быстро подготовили нужные бумаги, после чего мы составили договор. Деньги поступили на счет практически сразу.
                        </div>
                        <div class="review-person">
