...
<head>
    ...
    <title>Кредит под залог ПТС спецтехники <?= $in_city ?></title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-7">
                            <div class="header-form-block">
                                <h1 class="h1"><span class="h1-span">Кредит под залог ПТС спецтехники <br><?= $in_city ?></span></h1>
    ...
    <section id="interlayer-2">
        <div class="container">
            ...
            <figure class="get-image-interlayer visible-on-wade visible-on-tablet"><img src="images/subaru3.png" alt="subaru" style="margin: 148px 0 0 14px;">
            </figure>
        </div>
    </section>
...
<section id=products-1>
        ...
        <div class=container>
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class=image-max-height style="background-image: url(images/bgtrc.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;"></div>
                </div>
    ...
    <script type="text/babel">
        ...
        [{question: 'Можно ли получить займ под залог ПТС спецтехники? '},
            {answer: 'Да, наш автоломбард выдаёт займ под залог спецтехники. Величина суммы зависит от стоимости спецтехники клиента и некоторых других факторов. Мы готовы рассмотреть разные виды специальной техники.'},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: 'Какую спецтехнику вы принимаете в залог? '},
            {answer: 'Кредит под залог ПТС спецтехники могут получить разные люди. Наш автоломбард принимает бульдозеры, катки, тракторы, краны, погрузчики. Под залог перечисленных ТС люди могут взять займ.'},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: 'Как быстро я получу деньги под залог ПТС спецтехники? '},
            {answer: 'Автоломбард спецтехники под залог ПТС в Челябинске работает круглосуточно и без выходных. Люди могут даже ночью оставить заявку. Деньги будут выданы в течение 20-40 минут.'},
            {numId: '2'},
            {numIdText: 'Two'}],
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="owl-carousel owl-theme reviews-2 whiteColor">
                            <article class="review-bg-blue">
                                <div class="review-text">Займ под спецтехнику тоже оформляют. Мне выдали 70 тысяч рублей за мой прицеп. Процент нормальный, но запарился объяснять ситуацию по телефону. Вообще все отлично, можно обращаться. Выручили меня в трудный период!
                            ...
                            <article class="review-bg-blue">
                                <div class="review-text">Сказали, что среднегабаритные ТС подходят. Взял займ под залог ПТС спецтехники в Челябинске. Знакомый обращался сюда – пришел по его наводке. Остался доволен, ему выдали деньги без каких-то проблем, но у него малогабаритка была. У меня тоже всё прошло как по маслу)
                            ...
                            <article class="review-bg-blue">
                                <div class="review-text">Здесь даже залог спецтехники под ПТС работает. Я не знал, что под мой самосвал можно взять средства! Если честно, после общения с поддержкой, просто был в шоке. И сумма приличная… условия кусаются, но лучше все равно найти негде. Уже всё выплатил. Обращайтесь – не пожалеете!

                                </div>
                                <div class="review-person">
                                    <div class="review-name">Дима</div>
                                </div>
                            </article>
