...
<head>
    ...
    <title>Займ под залог ПТС <?= $in_city ?></title>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-7">
                            <div class="header-form-block">
                                <h1 class="h1"><span class="h1-span">Займ под залог ПТС <br><?= $in_city ?></span></h1>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                   Получить кредит в нашем автоломбарде под залог ПТС можно в короткий срок. Для этого потребуется пройти всего три этапа. Оставьте онлайн-заявку у нас на сайте. Дождитесь звонка менеджера, чтобы передать ему основные данные. Получите положительный ответ и приходите за деньгами.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    В случае одобрения заявки на кредит клиент может получить деньги любым удобным способом: наличными в кассе автоломбарда, который работает 24/7, или безналичным перечислением на банковский счет или карту. Комиссия за транш не взимается. 
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Понятие «займ под залог автомобиля» означает, что машина останется в пользовании у своего хозяина. Право собственности также остается за ним. В автоломбард необходимо передать только ПТС транспортного средства, которое выступит гарантом обеспечения кредита.
                                </div>
                            </div>
                        </div>
                    </div>
