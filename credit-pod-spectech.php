...
<head>
    ...
    <title>Займы под залог спецтехники <?= $in_city ?></title>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-7">
                            <div class="header-form-block">
                                <h1 class="h1"><span class="h1-span">Займы под залог спецтехники <br><?= $in_city ?></span></h1>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <h3 class="h1 m-t-image"><span class="h1-span"><span class="h1-span">Получение денег </span></span> <span class="yellow-text">под
                            залог спецтехники</span></h3>
                    </div>
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p4298/pogr.png" alt="займы"/>
                    </div>
                </div>
            </div>
        ...
        <div class=container>
            <div class=row>
                <div class="col-md-11 col-sm-12">
                    <h3 class=h1><span class=h1-span>Требования для получения </span>денежных средств под залог спецтехники</h3>
                ...
                <div class="owl-carousel owl-theme example-loan">
                    <div class="example-car right">
                        <div class="example-car-img"
                             style="background-image: url(images/example-loan/pogr.png);"></div>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                   Автоломбард предлагает получить займ не только под залог легкового автомобиля, но и под спецтехнику. 
Автоломбард под спецтехнику – это возможность увеличить оборотный капитал в короткие сроки. Сегодня этот вид кредитования так же популярен, как автокредит.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    На случай острой нехватки денег спасает кредит под залог автомобиля с правом пользования им. Автоломбард принимает в залог и спецтехнику, включая:
тракторы;
бульдозеры;
катки;
погрузчики и краны.
Автоломбард предлагает залог спецтехники под ПТС на самых выгодных условиях. 
                    ...
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Как быстро я получу деньги под залог ПТС?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">
                                    Главное преимущество получения займа под залог ПТС это скорость его оформления и выдачи денег. Процедура занимает от 20 до 40 минут времени. Заявку на займ под спецтехнику оставить можно круглосуточно!
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Если мне срочно нужны деньги, то я всегда обращаюсь в данный автоломбард. Здесь можно взять деньги под залог ПТС спецтехники в Сочи, это очень удобно, сотрудники доброжелательные, помогают оформить займ. Это занимает не так много времени. Всем рекомендую, когда ситуация  безвыходная – это отличное решение.
                                </div>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">В автоломбарде можно взять деньги под залог ПТС спецтехники, я узнал об этом совсем недавно, друг подсказал, когда срочно нужны были деньги. Здесь очень выгодные условия, и все занимает меньше 30 минут. 
                                </div>
                                <div class="review-person">
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Уже не раз обращаюсь в автоломбард, здесь можно под залог ПТС спецтехники взять деньги в займ. Когда срочно нужно, а в банках ждать долго, я всегда иду сюда, предлагают хорошие условия. Рекомендую всем!
                                </div>
                                <div class="review-person">
