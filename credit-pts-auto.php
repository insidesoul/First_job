...
<head>
    ...
    <title>Кредит под залог авто <?= $in_city ?></title>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-7">
                            <div class="header-form-block">
                                <h1 class="h1"><span class="h1-span">Кредит под залог авто <br><?= $in_city ?></span></h1>
            ...
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <h3 class="h1 m-t-image"><span class="h1-span"><span class="h1-span">Получение кредита </span></span> <span class="yellow-text">под
                            залог авто</span></h3>
                    </div>
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p4298/audi_1.png" alt="займы"/>
                    </div>
                </div>
            </div>
        ...
        <div class=container>
            <div class=row>
                <div class="col-md-11 col-sm-12">
                    <h3 class=h1><span class=h1-span>Требования для получения </span>кредита под залог авто</h3>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Можно ли получить кредит под ПТС, воспользовавшись генеральной доверенностью? 
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">
                                   Эта опция предусмотрена. Однако кредит в залог ПТС в Сочи по генеральной доверенности выдается только в том случае, если в документе (доверенности) предусмотрен пункт - выдача всех видов кредитов под залог самого транспорта или документов на него (в данном случае паспорт транспортного средства). Если в доверенности нет такого пункта, автокредит невозможен.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Для того чтобы получить кредит в залог ПТС  автомобиля в Москве нужно предоставить документы:
паспорт РФ
СТС;
ПТС.
Технический паспорт подтверждает возможность эксплуатации транспортного средства на дорогах общего пользования, документ невозможно подделать, оформление проходит строго в установленные законодательством сроки, поэтому финансовые организации не боятся выдавать большие суммы займа под залог ПТС.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">На какой срок я могу оформить кредит под ПТС? 
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">
                                    Оформить кредит наличными под ПТС возможно сроком от 1 до 5 лет.  Перед подачей заявки на сайте автоломбарда претендент должен «вооружиться» минимальным пакетом документов. Паспорт гражданина России - обязательное условие для создания контрактного соглашения на кредит под залог авто с правом вождения. 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Кредит под залог автомобиля очень удобно можно взять в автоломбарде. Главный плюс в том, что это очень быстро и не требуются справки, как в банках. Я уже 2 раза обращалась сюда, и осталась полностью довольна.
                                </div>
                            ...
                            <article class="review-bg-grey">
                                <div class="review-text">Если срочно нужны деньги, то можно взять кредит под ПТС автомобиля в Сочи, для этого я обращаюсь в автоломбард. Здесь отличные менеджеры, которые проконсультируют и предложат выгодные условия. А самый главный плюс, что не нужно долго ждать и и всё без бумажной волокиты. Для тех, кто официально не работает – это идеальный вариант.
                                </div>
                                <div class="review-person">
                                    <div class="review-name">Вадим Т.</div>
                                </div>
                            </article>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Я попала в сложную ситуацию, и мне срочно понадобились деньги. Для этого я обратилась в автоломбард, здесь можно взять кредит под ПТС. Долго сомневалась, так как думала, что здесь будут не выгодные условия для меня. Но я была приятно удивлена, когда мне предложили приемлемые условия займа. Всем рекомендую обращаться сюда. 
                            </div>
                            <div class="review-person">
                            ...
                            <article class="review-bg-grey">
                                <div class="review-text">Я взяла в этом автоломбарде кредит под залог под ПТС. Это очень удобно, не нужно тратить много времени. Всего 1 час и деньги уже у тебя. Я думала, что здесь будут бешеные проценты, но ошиблась, условия оказались достаточно хорошие, и я осталась довольна от сотрудничества. 
                                </div>
                                <div class="review-person">
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">У меня плохая кредитная история и в банках отказали в кредите, но я взял кредит в автоломбарде. Справки никакие не понадобились, дали даже с плохой кредитной историей, условия приемлемые, всем рекомендую. 
                            </div>
                            <div class="review-person">
