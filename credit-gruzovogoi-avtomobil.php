                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-on-figure">
                            <h1 class="h1"><span class="h1-span">Кредит под залог ПТС <br>грузового авто <?=$in_city ?></span></h1>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p3897/gruzovik.png"
                             alt="Автоломбард под залог ПТС  в Москва"/>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-5 col-sm-12">
                <div class="bg-grey-man">
                    ...
                    <img src="images/p3897/gruzo.png" alt="Автоломбард под залог ПТС"/>
                </div>
            </div>
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme example-loan">
                    <div class="example-car left">
                        ...
                        <div class="example-car-img" style="background-image: url(images/p3897/gruz.png); width: 42%; right: 100px;"></div>
                    </div>
...
<script type="text/babel">
    let data = [
        [{question: 'Могу ли я возвратить долг за грузовой автомобиль раньше условленного срока?'},
            {answer: 'После получения денег под залог грузового автомобиля Вы можете вернуть долг раньше условленного срока. Мы не взимаем пени, если Вы выплатите кредит заранее. Вы получите ПТС сразу после выплаты всей суммы.'},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: 'Переоформляется ли грузовое ТС на ваш автоломбард?'},
            {answer: 'Нет, автоломбард только выдает кредиты, мы не переоформляем транспортные средства на себя, вне зависимости от категории. Вы оставляете под залог только ПТС грузовика, мы не забираем другие документы.'},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: 'Важен ли возраст грузового автомобиля в процессе кредитования.'},
            {answer: 'Возраст является основным критерием при оформлении кредита. Мы принимаем отечественные ТС до 10 лет эксплуатации и импортные до 20 лет. Сумма кредита под залог ПТС грузовика высчитывается индивидуально.'},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
    ReactDOM.render(
                ...
                <div class="owl-carousel owl-theme reviews-3">
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">У меня плохая кредитная история, поэтому в банке мне отказали сразу. Попробовал взять деньги под залог грузового автомобиля — все получилось. Оформили быстро, не требовали кучу документов. Понравилось то, что реальная оценка стоимости, не занижают. Отличный вариант, когда сложная финансовая ситуация!</div>
                        </div>
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Оформлял залог под ПТС грузового автомобиля. Быстро оценили и заключили договор, авто осталось при мне. Брал на небольшой период, поэтому переплата получилась минимальная. Есть возможность досрочного погашения, чем я и воспользовался. Сотрудничеством остался доволен.</div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Залог грузовых авто — удобная услуга, которой мне пришлось воспользоваться. Нужна была крупная сумма, в наличии у меня два грузовых авто. Взял под них кредит. Оформили быстро под хороший процент, сейчас выплачиваю. Здесь работают настоящие профессионалы — в этом сам убедился! Спасибо, помогли решить сложную жизненную ситуацию.</div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Уже два раза оформлял займ под залог грузового автомобиля. Первый раз брал на небольшой период, выплатил быстро. Сейчас выплачиваю второй. У сотрудников профессиональный подход, все объясняют и реально оценивают транспортное средство. Переплата получается небольшая, если на небольшой период. В целом, остался доволен, так как других вариантов взять кредит просто не было.</div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Если нужен займ под грузовой автомобиль в Москве, обращаться следует именно в эту компанию. Все преимущества сотрудничества я смог оценить лично — быстрое оформление, реальная оценка, срочная выплата денег. Из документов потребовали ПТС и паспорт — минимум, не пришлось брать никаких справок. Очень доволен!</div>
                        </div>
                        <div class="review-person">
