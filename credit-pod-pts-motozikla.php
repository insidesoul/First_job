...
<head>
    ...
    <title>Займы под залог мототехники <?= $in_city ?></title>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-7">
                            <div class="header-form-block">
                                <h1 class="h1"><span class="h1-span">Займы под залог мототехники <br><?= $in_city ?></span></h1>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <h3 class="h1 m-t-image"><span class="h1-span"><span class="h1-span">Получение денег </span></span> <span class="yellow-text">под
                            залог мототехники</span></h3>
                    </div>
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p4298/mot.png" alt="займы"/>
                    </div>
                </div>
            </div>
        ...
        <div class=container>
            <div class=row>
                <div class="col-md-11 col-sm-12">
                    <h3 class=h1><span class=h1-span>Требования для получения </span>денежных средств под залог мототехники</h3>
                ...
                <div class="owl-carousel owl-theme example-loan">
                    <div class="example-car right">
                        <div class="example-car-img"
                             style="background-image: url(images/example-loan/mot.png);"></div>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Могу ли я вернуть деньги за свой мотоцикл раньше условленного срока?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">
                                   Получая займ в автоломбарде под залог мотоцикла, вернуть деньги раньше оговоренного срока можно! Процедура не влечет за собой никакой пени и последствий.
                                   Автоломбард под залог ПТС мотоцикла предлагает своим заемщикам только выгодные условия. 
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Это категорически запрещено! Компания дает возможность только кредитования. Получить займ под залог ПТС мотоцикла можно в онлайн режиме, заполнив заявку и дождавшись решения. Процесс занимает до 40 минут. Наличие мобильного телефона ускорит процесс сделки при прохождении регистрационной процедуры и активации договора в онлайн-режиме.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Автоломбард  выдает займ под ПТС мототехники на срок от 1 до 5 лет. Вы сами решаете, как долго вы готовы вернуть деньги. Этот момент согласовывается в процессе регистрации. При принятии решения ориентируйтесь на сумму кредита, общую ежемесячную финансовую нагрузку на бюджет и размер выручки. 
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Уже не первый раз беру деньги под залог ПТС мототехники. Очень доволен, все быстро, сотрудники помогут, ответят на все вопросы, условия приемлемые. Если нужны деньги здесь и сейчас, то это отличный вариант.
                                </div>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Если мне срочно необходимы деньги, то я всегда обращаюсь в автоломбард, здесь можно взять деньги под залог ПТС мототехники, это очень быстро и удобно, условия выгоднее чем в МФО, всем советую.
                            </div>
                            <div class="review-person">
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Несколько раз обращался в этот автоломбард, здесь можно взять деньги под залог ПТС мототехники, очень удобно, что не нужно ждать и нужную сумму можно получить прямо здесь и сейчас, для этого всего лишь необходимо оставить в залог ПТС.
                                </div>
                                <div class="review-person">
