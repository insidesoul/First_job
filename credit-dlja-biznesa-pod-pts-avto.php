                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="content-on-figure">
                            <h1 class="h1"><span class="h1-span">Кредит для юр. лиц под <br>залог ПТС <?=$in_city ?></span></h1>
...
<script type="text/babel">
    let data = [
        [{question: 'Можно ли оформить кредит под ПТС авто, воспользовавшись генеральной доверенностью?'},
            {answer: 'Кредит под залог ПТС для юридических лиц доступен владельцу ТС и его доверенному лицу. Вы должны предоставить официальное подтверждение, что владелец транспортного средства передал Вам все полномочия по распоряжению имуществом.'},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: 'Как заложить ПТС без отказа и с низким процентом по доверенности?'},
            {answer: 'Кредит для юридических лиц под залог авто выдается при предъявлении паспорта гражданина РФ, ПТС и СТС. Если транспортное средство соответствует нормам, Вы получите займ с низким процентом.'},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: 'На какой срок я могу оформить кредит под ПТС машины?'},
            {answer: 'Кредит юр. лицам под залог автомобиля выдается на срок от 1 до 5 лет. Вы можете выплатить всю сумму раньше срока, прописанного в договоре. В таком случае пени не взимается.'},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
    ReactDOM.render(
                ...
                <div class="owl-carousel owl-theme reviews-3">
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Когда попал в сложную ситуацию, сразу оформил залог под ПТС для юридических лиц. Его мне друг порекомендовал. Брал деньги под залог двух авто на три месяца. Условия реальные, процент выгодный. При сотрудничестве никаких подводных камней и обмана. Сотрудники настоящие профессионалы, отвечают на все вопросы, вежливые и обходительные. Такое в автоломбарде реально редко можно встретить.</div>
                        </div>
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Оформлял кредит под залог ПТС для юридических лиц. Сотрудничеством доволен. Процент выгодный, есть возможность отсрочки платежа, что порадовало. Оформляют договор быстро, а стоимость транспорт средств определяют максимально оперативно. Понравилось именно то, что все делают быстро, никакой волокиты с документами.</div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Кафе было на грани банкротства, подруга посоветовала оформить кредит для ИП под залог автомобиля. Обратилась в компанию, сделали все быстро, деньги получила сразу. Как только разобралась с финансовыми проблемами, досрочно погасила кредит, поэтому много переплачивать не пришлось. При всем этом, требуют минимум документов, оптимальный вариант для занятых людей, которые не хотят тратить свое время зря.</div>
                        </div>
                        <div class="review-person">
