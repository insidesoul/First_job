                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="owl-carousel owl-theme reviews-2 whiteColor">
                            <article class="review-bg-blue">
                                <div class="review-text">Раньше никогда не брал кредитов, а когда понадобились деньги, банк дал отказ по причине отсутствия кредитной истории. Ну и ладно, ведь теперь у меня есть контора, которой я могу доверять и быть уверенным, что мне не откажу. Кредит под залог ПТС машины был выдан в день оформления заявки!
                            ...
                            <article class="review-bg-blue">
                                <div class="review-text">Хотел взять кредит под залог авто, но долго не мог выбрать компанию. Эта контора заинтересовала высокой скоростью оформления, минимум требований к клиенту. Очень вежливые менеджеры, возможность заполнить заявку онлайн, быстрое решение – главные плюсы, которые я выделил для себя.

                                </div>
                                <div class="review-person">
                                    <div class="review-name">Артемий</div>
                                </div>
                            </article>
                            <article class="review-bg-blue">
                                <div class="review-text">Когда оформляла кредит наличными под залог ПТС авто, обратила внимание на то, что никто из сотрудников компании не стремится сделать задачу невыполнимой, напротив, девушка-менеджер оказывала всяческую помощь при заполнении заявки. Порадовал удобный график выплат, возможность досрочного погашения без штрафных санкций.

                                </div>
                                <div class="review-person">
                                    <div class="review-name">Валентина</div>
                                </div>
                            </article>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                   Организации или крупные предприниматели, которые обращаются к нам, чтобы получить кредит под залог машины, не лишаясь ее, получают выгодные условия по выплатам. Срок, на который мы выдаем заем, составляет от года до 5 лет – исходя из его общей суммы.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Нет, нас это не интересует. Получить кредит в залог ПТС у нас в компании можно лишь на основании наличия этого документа. Мы не оставляем транспортные средства у себя, и не проверяем, закрыты ли уже кредиты предпринимателей в банковских организациях.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Мы постарались, чтобы взять кредит под залог машины в Ставрополе стало максимально просто, и поэтому наши требования легко выполнимы. Достаточно, чтобы Ваша техника была исправной, а срок ее эксплуатации не превышал 10 лет (для иностранных – 20 лет).
                                </div>
                            </div>
                        </div>
                    </div>
