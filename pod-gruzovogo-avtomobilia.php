...
<head>
    ...
    <title>Кредит под залог ПТС грузового авто <?= $in_city ?></title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-7">
                            <div class="header-form-block">
                                <h1 class="h1"><span class="h1-span">Кредит под залог ПТС грузового авто <br><?= $in_city ?></span></h1>
    ...
    <section id="interlayer-2">
        <div class="container">
            ...
            <figure class="get-image-interlayer visible-on-wade visible-on-tablet"><img src="images/subaru4.png" alt="subaru" style="margin: 148px 0 0 14px;">
            </figure>
        </div>
    </section>
...
<section id=products-1>
        ...
        <div class=container>
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class=image-max-height style="background-image: url(images/bgtrcc.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;"></div>
                </div>
    ...
    <script type="text/babel">
        ...
        [{question: 'Могу ли я возвратить долг за грузовой автомобиль раньше условленного срока?'},
            {answer: 'Если клиент взял деньги под залог грузового автомобиля, у него будет возможность погасить долг раньше установленного срока. В этом случае наша компания не начислит пени.'},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: 'Переоформляется ли грузовое ТС на ваш автоломбард? '},
            {answer: 'Мы готовы дать деньги в залог под ПТС грузовика, но при этом не станем переоформлять транспортное средство на свой автоломбард. Занимаемся исключительно кредитованием.'},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: 'Важен ли возраст грузового автомобиля в процессе кредитования?'},
            {answer: 'При выдаче денег в залог под ПТС грузовика в Челябинске мы учитываем возраст транспортного средства. Готовы выдать кредит, если авто не старше определённого возраста: отечественные – до 10 лет, импортные – до 20 лет.'},
            {numId: '2'},
            {numIdText: 'Two'}],
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="owl-carousel owl-theme reviews-2 whiteColor">
                            <article class="review-bg-blue">
                                <div class="review-text">Специалист быстро помог оформить займ под залог ПТС моего грузового автомобиля. Сначала долго не решался – жалко было, что останется у них. Но нет, под залог – это значит могу пользоваться, если выплачиваю! Оператор – милая девушка, со всем помогла.
                            ...
                            <article class="review-bg-blue">
                                <div class="review-text">Оформился быстро. Брал под залог грузовых авто нашей компании в Челябинске. Если честно, думал будет сложение. На горячей линии проконсультировали, назвали примерную сумму за мой фургон, при встрече оказалась сумма даже немного больше. Деньги выдали сразу же после оформления договора.
                            ...
                            <article class="review-bg-blue">
                                <div class="review-text">Получил деньги в залог под ПТС моего грузовой машины. Трудностей при оформлении не возникло. Всё по закону, специалисты хорошие. Ко мне на объект приехал выездной специалист, оформили быстро, грамотный договор займа.
