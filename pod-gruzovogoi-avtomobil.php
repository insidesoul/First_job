...
<head>
    ...
    <title>Сеть автоломбардов Санкт-Петербурга под залог ПТС грузовых авто</title>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-7">
                    <div class="header-form-block">
                        <h1 class="h1"><span class="h1-span">Сеть автоломбардов <br>Санкт-Петербурга</span>под залог ПТС грузовых авто</h1>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="product-template-bg">
                                        <div class="element-img grey" style="background-image: url(images/p4298/gazel.png);"></div>
                                        <div class="element-title"><a href="#">Газели</a></div>
                                        <div class="element-text">Грузовые, пассажирские</div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="product-template-bg">
                                        <div class="element-img grey" style="background-image: url(images/p4298/trackk.png);"></div>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="product-template-bg">
                                        <div class="element-img grey" style="background-image: url(images/p4298/tagah.png);"></div>
                                        <div class="element-title"><a href="#">Тягачи</a></div>
                                        <div class="element-text">Отечественные и импортные</div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="product-template-bg">
                                        <div class="element-img grey" style="background-image: url(images/p4298/pricep.png);"></div>
                                        <div class="element-title"><a href="#">Прицепы</a></div>
        ...
        <div class="row">
            <div class="col-md-5 col-sm-12">
                <div class="bg-grey-man">
                    ...
                    <img src="images/p4298/carss.png" alt="Автоломбард под залог ПТС"/>
                </div>
            </div>
            <div class="col-md-6 col-sm-12">
                <div class="thank-answer-block">
                    ...
                    <div class="thank-answer">
                        <div class="thank-answer-img"><img src="images/p4298/moneyRed.png"
                    ...
                    <div class="thank-answer">
                        <div class="thank-answer-img"><img src="images/p4298/icon_19.png"
                                                           alt="Автоломбард под залог ПТС"/></div>
                        <div class="thank-answer-text">
                    ...
                    <div class="thank-answer">
                        <div class="thank-answer-img"><img src="images/p4298/icon_39.png"
                                                           alt="Автоломбард под залог ПТС"/></div>
                        <div class="thank-answer-text">
                    ...
                    <div class="thank-answer">
                        <div class="thank-answer-img"><img src="images/p4298/icon_40.png"
                                                           alt="Автоломбард под залог ПТС"/></div>
                        <div class="thank-answer-text">
...
<script type="text/babel">
    let data = [
        [{question: 'Могу ли я возвратить долг за грузовой автомобиль раньше установленного срока?'},
            {answer: 'Вы можете вернуть полученные деньги под залог грузового автомобиля раньше указанного срока. В отношении вас не будет применяться никаких санкций. Вы оплачиваете проценты только за фактический срок пользования кредитом.'},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: 'Переоформляется ли грузовое ТС на ваш автоломбард.'},
            {answer: 'В рамках программы залог ПТС грузовика, наша компания только кредитует заемщика, иные действия в отношении транспортного средства не предусмотрены. '},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: 'Важен ли возраст автомобиля в процессе кредитования?'},
            {answer: 'Да, при оформлении залога ПТС грузовика в СПб возраст автомобиля играет роль. Важно, чтобы ваш отечественный автомобиль был в эксплуатации не более 10 лет, на иностранные автомобили – возраст увеличен до 20 лет.'},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
    ReactDOM.render(
            ...
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 info-index">
                                <div class="text-info-index">
                                    <div class="text-info-icon"><img class="newImages"  src="images/icon/icon_22.png" alt="Автозайм под птс в Екатеринбурге" /></div>
                            ...
                            <div class="col-md-6 col-sm-6 info-index">
                                <div>
                                    <div class="text-info-index">
                                        <div class="text-info-icon"><img  class="newImages" src="images/icon/icon_21.png" alt="Автозайм под птс в Екатеринбурге" /></div>
                                        <div class="text-info-title">10 лет успешной работы</div>
                                    </div>
                                    <div class="text-info-index">
                                        <div class="text-info-icon"><img class="newImages"  src="images/icon/icon_20.png" alt="Автозайм под птс в Екатеринбурге" /></div>
                ...
                <div class="col-md-4 visible-on-mobile">
                    <div class="owl-carousel owl-theme documents-2">
                        <div class="text-info-index">
                            <div class="text-info-icon"><img src="images/icon/icon_22.svg" alt="Автозайм под птс в Екатеринбурге" /></div>
                            <div class="text-info-title">Соответствуем законодательству РФ</div>
                        </div>
                        <div class="text-info-index">
                            <div class="text-info-icon"><img src="images/icon/icon_21.svg" alt="Автозайм под птс в Екатеринбурге" /></div>
                            <div class="text-info-title">10 лет успешной работы</div>
                        </div>
                        <div class="text-info-index">
                            <div class="text-info-icon"><img src="images/icon/icon_20.svg" alt="Автозайм под птс в Екатеринбурге" /></div>
                            <div class="text-info-title">Участник лиги автоломбардов</div>
                        </div>
                        <div class="link-button">
                            <a data-toggle="modal" href="#CallPhone-ver-4">Подать заявку <span class="arrow"></span></a>
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Получил под залог ПТС грузового автомобиля необходимую сумму. У меня свой бизнес, работаю за рулем. Вот как-раз предоставил под залог грузовик, чтобы получить деньги и потратить их на развитие бизнеса. Благодаря этому существенно увеличил свой доход, а займ вернул без проблем.
                        </div>
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Здесь самый выгодные займы под залог под ПТС грузового автомобиля, нигде не встречал таких условий. Обслуживают быстро и качественно. Два месяца назад получил здесь деньги под залог грузового авто. Сотрудники компании составили документы быстро, мне осталось только подписать.
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Если хотите получить деньги под залог грузового авто, то рекомендую данную организацию. Условия выгодные, процент минимальный. Все документы для заключения сделки составляются быстро, менеджеры охотно идут навстречу и готовы составить для вас максимально удобный график погашения задолженности.
                        </div>
                        <div class="review-person">
                            <div class="review-name">Бахтияр</div>
                        </div>
                    </article>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <ul class="footer-li bold">
                            <li><a href="pod-automobil.php">Кредит под ПТС</a></li>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <ul class="footer-li bold">
                            ...
                            <li><a href="pod-pts.php">Займ под ПТС</a></li>
                        </ul>
                    </div>
            ...
            <div class="col-md-12">
                <div class="footer-bottom">
                    <p>«Сеть автоломбардов Петербурга» не является финансовым учреждением, банком или МФО. Сайт предоставляет
