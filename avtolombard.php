                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-7">
                            <div class="header-form-block">
                                <h1 class="h1"><span class="h1-span">Автоломбард под залог ПТС <br><?= $in_city ?></span></h1>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Как получить займ под залог ПТС в автоломбарде?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">
                                   Если хотите быстро получить деньги под ПТС в Хабаровске, обращайтесь в наш автоломбард. Для начала оформите онлайн-заявку на сайте. После того, как с вами свяжется менеджер нашей компании, предоставьте ему все запрашиваемые данные. И, наконец, лжидайте принятия положительного решения.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Уникальная возможность оформления и получения кредита полностью онлайн доступна в нашем автоломбарде. Под залог ПТС выдадим нужную клиенту сумму, машина останется в пользовании. Подайте заявку через сайт, передайте данные по телефону и получите деньги на банковскую карту. 
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Да, в нашем автоломбарде лояльные условия выдачи кредитов под залог ПТС. Мы предлагаем получить займ тем, у кого есть генеральная доверенность на ТС и кто предъявит договор купли-продажи. Регистрация машины не влияет на приятие решения о кредитовании.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Хочу поблагодарить ваш автоломбард за выгодные условия кредита под залог ПТС. На практике, займ оказался очень выгодным. Мне даже оставили машину, забрали только ПТС. Вернули сразу после выплаты денег. Рекомендую! 
                                </div>
                            ...
                            <article class="review-bg-grey">
                                <div class="review-text">В автоломбарде взяла кредит под залог ПТС в Хабаровске и полностью довольна всеми условиями. Обращалась впервые, столько страхов было, а консультант все подробно разъяснил. За это отдельное спасибо.
                                </div>
                                <div class="review-person">
                                    <div class="review-name">Рената</div>
                                </div>
                            </article>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Рекомендую всем этот ломбард, если нужны деньги под залог ПТС авто. Оформили в этот же день, осмотр машины занял всего несколько минут. И не пришлось отдавать единственный семейный транспорт.
                                </div>
                                <div class="review-person">
                            ...
                            <article class="review-bg-grey">
                                <div class="review-text">Отличный ломбард и единственный, где мне одобрили кредит под залог автомобиля. В других местах мне вообще отказали и не назвали причину. Здесь же все оформили буквально за сутки, за что отдельное спасибо.
                                </div>
                                <div class="review-person">
                                    <div class="review-name">Ярослав</div>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Если вы ищете круглосуточный автоломбард - вам сюда. Около 10 вечера срочно понадобились деньги, и я обратился сюда. Оформили кредит в срочном порядке. Спасибо вам за отзывчивость и скорость!
                                </div>
                                <div class="review-person">
