        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p4298/audi_13.png" alt="Автоломбард под залог ПТС"/>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="car-top-transports">
                            ...
                            <div class="car-top-transports1">
                                <img src="images/bmwc.png" alt="bmm">
                            </div>
                            <div class="visible-on-wade visible-on-tablet">
                            ...
                            <div class="visible-on-mobile request-history">
                                <div class="m-b-30">
                                    <img style="max-width: 200px; width: 100%;" src="images/bmwc.png" alt="img" />
                                </div>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                   Наша компания предоставляет кредиты, которые имеют обеспечение. Оформляем займ под залог спецтехники в день обращения всем категориям заемщиков — юридическим и физическим лицам. При этом сама машина останется в пользовании, в автоломбард передается только ПТС.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    При оформлении займа в нашем автоломбарде в качестве залога могут выступать наиболее востребованная специализированная техникя. Принимаются следующие виды строительных, дорожных и сельскохозяйственных машин: краны, тракторы, погрузчики, бульдозеры, катки. Оформляя кредит под залог ПТС спецтехники у нас, вы продолжаете ею пользоваться.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Если заемщик представляет полный пакет документов (паспорт, ПТС и СТС), он может получить деньги уже через 20 минут после подачи заявки. Максимальный срок рассмотрения — до 40 минут. Вы можете круглосуточно подать заявку на кредит в наш автоломбард. Принимаем разные виды спецтехники под залог ПТС в Хабаровске 24/7.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Быстро оформили займ под залог ПТС спецтехники в Хабаровске. Условия выбрал сам, а консультант помог, за что отдельное спасибо. Это, наверное, единственный ломбард в Хабаровске, где мне не отказали.
                                </div>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Отличная услуга, буду пользоваться снова! Получил займ под спецтехнику (у меня самосвал) и даже успел всё довольно быстро вернуть. Не думал, что такие «вкусные» условия будут правдой, но спасибо за это.
                                </div>
                                <div class="review-person">
                                    <div class="review-name">Марк</div>
                                </div>
                            </article>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Оформил займ под залог спецтехники и не пожалел. Боялся, что заберут трактор, и я не смогу работать на нём (а как еще мне долг вернуть-то). Но в этой компании понадобился только ПТС. Однозначно рекомендую всем!
                                </div>
                                <div class="review-person">
